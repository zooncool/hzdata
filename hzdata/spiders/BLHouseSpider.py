...
class HouseSpider(scrapy.Spider):
    ...
    def parse_house(self, response):
        ...
        pre_total_square = response.xpath("//table[1]//tr[14]/td[1]/text()").extract_first().strip()
        actual_total_square = response.xpath("//table[1]//tr[14]/td[2]/text()").extract_first().strip()
        pre_inner_square = response.xpath("//table[1]//tr[15]/td[1]/text()").extract_first().strip()
        actual_inner_square = response.xpath("//table[1]//tr[15]/td[2]/text()").extract_first().strip()
        pre_public_square = response.xpath("//table[1]//tr[16]/td[1]/text()").extract_first().strip()
        actual_public_square = response.xpath("//table[1]//tr[16]/td[2]/text()").extract_first().strip()
        is_pledge = response.xpath("//table[1]//tr[18]/td[1]/text()").extract_first().strip()
        is_seal = response.xpath("//table[1]//tr[18]/td[2]/text()").extract_first().strip()
